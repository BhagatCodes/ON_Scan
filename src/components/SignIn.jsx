...
const SignIn = () => {
    return(
        <div className="w-full min-h-screen p-4 sm:p-7">
            <div className= "bg-no-repeat bg-cover rounded-[40px] w-full min-h-[calc(100vh-56px)] py-8 sm:py-[140px] flex flex-col items-center justify-center gap-3 sm:gap-6" style={{ backgroundImage: `url(${bgAuth})` }}>
